...
<div class="Container-fluid ml-5 mr-5">
 ...
 ?>
    <form class="row my-5" action="./../controllers/foodCreate.php" method="POST" enctype="multipart/form-data">
        <div class="col-lg-12">
        ...
        <div class="col-lg-6">
            ...
            <input name="price" class="form-control mb-4" >
        ...
        <label for=""> Enter your Catagory </label>
         <select name="category_id" id="" class="form-control mb-4">
         <?php
